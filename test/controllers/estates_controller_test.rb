...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { adress: @estate.adress, age: @estate.age, name: @estate.name, note: @estate.note, rent_fee: @estate.rent_fee } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { adress: @estate.adress, age: @estate.age, name: @estate.name, note: @estate.note, rent_fee: @estate.rent_fee } }
